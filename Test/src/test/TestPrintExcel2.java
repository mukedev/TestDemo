...
public class TestPrintExcel2 {
	...
	public static void main(String[] args) {
			...
			persons.add(new TestPrintExcel2().new Persons("亚索", "男", 23));
			persons.add(new TestPrintExcel2().new Persons("亚索1", "男",19));
			persons.add(new TestPrintExcel2().new Persons("亚索2", "男", 21));
			
			HSSFWorkbook hssfWorkbook =TestPrintExcel2.export_text(persons);
